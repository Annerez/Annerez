...
I just love seeing new architecture published every day. I still remember the first time I was introduce to [Transformer](https://en.wikipedia.org/wiki/Transformer_(deep_learning_architecture)). (A deep learning architecture, not those sentient robot cars from outer space.)
